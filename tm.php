...
background-position:0px 0px;font-family:'AR CENA'">
  ...
  <div class="caption">
  <h1><center>
  <font color='black' ></font></center></h1>
...
<div id="section1"  style="height:670px;background-image:url(07.jpg);background-repeat:no-repeat;backround-size:1370px 570px;background-position:0px 0px;">
...
<div id="section4" class="container-fluid" style="height:700px; background-image:url(33.jpg);background-color:black; background-size:5000px 700px;background-repeat:no-repeat;
background-position:0px 0px;font-family:'AR CENA'">
</br></br>
...
<form role="form"  class="form-signin" action="#section4" method="post">
  <input type="text" style="left=100" name="search" class="a" placeholder="       Enter City Name..">
  </form>
</br>
 <div align="center"> 
<div class="panel panel-primary"  align="center" style=" width:1000px ">
  
  <div class="panel-body fixed-panel" align="center" style=" width:1000px ;min-height: 0px; max-height: 400px;background-image:url(32.jpg)" >
...
<?php
  ...
  // echo $count;
   ...
   {   
	    echo "<div class='thumbnail' align='center' style='background-color:$a[$flag];position:relative;left:30px;width:700px'>".
	        "<div class='row'>".
			"<div class='col-sm-4'>".
...
<div id="section3" class="container-fluid" style="height:100%px; background-image:url(03.jpg);background-color:black; background-size:1370px 1200px;background-repeat:no-repeat;
background-position:0px 0px;font-family:'AR CENA'"">
...
<form role="form"  class="form-signin" action="sample11.php" method="post" style="width:570px;background-color:white"  >
  <div class="imgcontainer">
    <h3>Sign In</h3></br>
	<img src="j05.gif" alt="Avatar" class="avatar" width="40" height="110">
  </div>
