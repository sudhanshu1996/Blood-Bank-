<?php
   $servername = "localhost";
	...
	//echo "welcom";
if(isset($_POST['ename'])&& isset($_POST['orgid'])&& isset($_POST['add'])&& isset($_POST['city'])&& isset($_POST['date'])&& isset($_POST['time']))
{
   $name= $_POST["ename"];
   $oid= $_POST["orgid"];
   $addr= $_POST["add"];
...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a data-toggle="tab" href="#menu3">Event</a></li>
  </ul>
  ...
  <div class="tab-content">
   ...
   {   
	    echo "<h1 align='center'><font color='white'>{$row['oname']} Blood Organisation</font></h1>".
	        "<h3 align='center'><font color='white'>(A {$row['otype']} organization)</font><h3><br>".
            "<font color='white'>Number of Doner:$count1  <span class='tab-space'></span><span class='tab-space'></span> Number of Reciever:$count2</font><br><br>".
    ...
    <div id="menu3" class="tab-pane fade in active">
      ...
      <div align="center">
      <?php
         if(mysqli_query($link,"INSERT INTO event(ename,orgid,addr,city,date,time) VALUES ('$name','$oid','$addr','$city', '$date','$time')"))
		 {
	...
	<div class="form-group" align="center">
       ...
       <input type="text" class="form-control" style="width:500px; "name="time" placeholder="email">
    </div>
	<div class="form-group" align="center">
