<?php
   $servername = "localhost";
	...
	//echo "welcom";
if(isset($_POST['dname'])&& isset($_POST['Did'])&& isset($_POST['blood'])&& isset($_POST['orgid'])&& isset($_POST['amount']))
{
   $name= $_POST["dname"];
   $did= $_POST["Did"];
   $oid= $_POST["orgid"];
...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a data-toggle="tab" href="#menu1">Doner</a></li>
  ...
  <div class="tab-content">
   ...
   {   
    ...
    <div id="menu1" class="tab-pane fade in active">
      ...
      <div align="center">
	  <?php
         if(mysqli_query($link,"INSERT INTO doner2(name,Did,bgp,Oid,amt) VALUES ('$name','$did','$bgp','$oid', '$amt')") && mysqli_query($link,"UPDATE bloods SET $bgp='$count4' WHERE oid='$oid'"))
		 {
